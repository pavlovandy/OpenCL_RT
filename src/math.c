...
/*   Updated: 2019/09/26 18:09:46 by apavlov          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
cl_double3	transpone_basis(cl_double3 point, t_rotation_matrix m)
{
	...
	res.s[0] = m.e1.s[0] * point.s[0] + m.e2.s[0] * point.s[1] + m.e3.s[0] * point.s[2];
	res.s[1] = m.e1.s[1] * point.s[0] + m.e2.s[1] * point.s[1] + m.e3.s[1] * point.s[2];
	res.s[2] = m.e1.s[2] * point.s[0] + m.e2.s[2] * point.s[1] + m.e3.s[2] * point.s[2];
	return (res);
}
